...
void write_to_file(const std::string &path, uint64_t start_id, int num) {
...
int main(int argc, char *argv[]) {
  write_to_file("person_list1", 421003198607262336, 1024);
  write_to_file("person_list2", 421003198707262336, 2048);
  check_file("person_list1");
  check_file("person_list2");
  return 0;
}
