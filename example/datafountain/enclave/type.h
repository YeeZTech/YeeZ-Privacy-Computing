...
typedef ff::util::ntobject<id, A1, A2, A3, A4, A5, A6, B1, B2, B3, B4, B5, B6,
                           B7, B8, B9, B10, B11, B12, B13>
    pred_a_item_t;
typedef train_b_item_t pred_b_item_t;
typedef ff::util::ntobject<id, A1, A2, A3, A4, A5, A6, B1, B2, B3, B4, B5, B6,
                           B7, B8, B9, B10, B11, B12, B13, C1, C2, C3, C4, C5,
                           C6, C7, D1, D2, D3, D4, D5, D6, D7, D8, D9, D10, D11,
                           D12, D13>
    pred_merge_item_t;
