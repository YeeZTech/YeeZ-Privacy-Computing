...
contract TestProgramStore{
    ...
    function upload_program(string memory _name, string memory _desc, string memory _url, uint256 _price, bytes32 _hash) public returns(bytes32){
