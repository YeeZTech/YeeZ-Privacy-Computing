...
class version {
public:
  inline version() : m_data() { m_data.m_data = 0; }
  explicit version(uint64_t data) : m_data() { m_data.m_data = data; };
  ...
  friend inline bool operator<(const version &v1, const version &v2) {
    ...
    if (v1.m_data.m_detail.m_minor_version <
        v2.m_data.m_detail.m_minor_version) {
      return true;
    }
    if (v1.m_data.m_detail.m_patch_version <
