...
TEST(test_sm3_hash, sha3_256) {
  ypc::bytes msg = ypc::hex_bytes(
          ...
          .as<ypc::bytes>();
  uint8_t hash[32];
  uint32_t ret = ypc::crypto::sm3_hash::sha3_256(msg.data(),
                                                 msg.size(), hash);                                             
  EXPECT_EQ(ret, 0);
  ...
  ypc::bytes msg_4 = ypc::hex_bytes(
          ...
          .as<ypc::bytes>();
  uint8_t hash_4[32];
  uint32_t ret_4 = ypc::crypto::sm3_hash::sha3_256(msg_4.data(),
                                                 msg_4.size(), hash_4);                                             
  EXPECT_EQ(ret_4, 0);
  ...
  ypc::bytes msg_5 = ypc::hex_bytes(
          ...
          .as<ypc::bytes>();
  uint8_t hash_5[32];
  uint32_t ret_5 = ypc::crypto::sm3_hash::sha3_256(msg_5.data(),
                                                 msg_5.size(), hash_5);                                             
  EXPECT_EQ(ret_5, 0);
  ...
  printf("5\n");
    ...
    ypc::bytes msg_6 = ypc::hex_bytes(
          ...
          .as<ypc::bytes>();
  uint8_t hash_6[32];
  uint32_t ret_6 = ypc::crypto::sm3_hash::sha3_256(msg_6.data(),
                                                 msg_6.size(), hash_6);                                             
  EXPECT_EQ(ret_6, 0);
  ...
  printf("6\n");
    ...
    ypc::bytes msg_7 = ypc::hex_bytes(
          ...
          .as<ypc::bytes>();
  uint8_t hash_7[32];
  uint32_t ret_7 = ypc::crypto::sm3_hash::sha3_256(msg_7.data(),
                                                 msg_7.size(), hash_7);                                             
  EXPECT_EQ(ret, 0);
  ...
  printf("7\n");
    ...
    ypc::bytes msg_8 = ypc::hex_bytes(
          ...
          .as<ypc::bytes>();
  uint8_t hash_8[32];
  uint32_t ret_8 = ypc::crypto::sm3_hash::sha3_256(msg_8.data(),
                                                 msg_8.size(), hash_8);                                             
  EXPECT_EQ(ret_8, 0);
  ...
  ypc::bytes msg_9 = ypc::hex_bytes(
          ...
          .as<ypc::bytes>();
  uint8_t hash_9[32];
  uint32_t ret_9 = ypc::crypto::sm3_hash::sha3_256(msg_9.data(),
                                                 msg_9.size(), hash_9);                                             
  EXPECT_EQ(ret_9, 0);
  ...
  printf("9\n");
    ...
    ypc::bytes msg_10 = ypc::hex_bytes(
          ...
          .as<ypc::bytes>();
  uint8_t hash_10[32];
  uint32_t ret_10 = ypc::crypto::sm3_hash::sha3_256(msg_10.data(),
                                                 msg_10.size(), hash_10);                                             
  EXPECT_EQ(ret_10, 0);
