from multistream_job_offchain import multistream_job_offchain
import os
import common
...
if __name__ == "__main__":
    ...
    parser = os.path.join(common.lib_dir, "person_first_match_multi_offchain.signed.so")
    plugin = os.path.join(
    ...
    cj = multistream_job_offchain(crypto, name, data, parser, plugin, input_param, {
