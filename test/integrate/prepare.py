...
class classic_job:
    ...
    def run(self):
        ...
        parser_input = {"shu_info":{
            ...
            "keymgr_path":common.kmgr_enclave["stdeth"],
        ...
        parser_output_file = sys.argv[5] # self.name + ".classifier.parser_output.json"
...
if __name__ == "__main__":
    ...
    input_param = {"sepal-len":sys.argv[1],
                "sepal-wid":sys.argv[2],
                "petal-len":sys.argv[3],
                "petal-wid":sys.argv[4]}
